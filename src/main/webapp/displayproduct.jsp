            ...
            <nav class="nav-menu" id="nav-menu">
                 <ul class="nav-list">
                    ...
                    else
                    {
                    	...
                    	<li><a href="cart.jsp" class="nav-link">View Cart</a></li>
...
try{
	...
	if(request.getParameter("add") != null)
	{
		...
		if(request.getParameter("product_name") != null || request.getParameter("product_price") != null || request.getParameter("product_image") != null)
		{
...
//			String rid = request.getParameter("rid");
		    ...
		    PreparedStatement ps = con.prepareStatement("insert into cart(name,price,image,quantity,user_id,pid) values(?,?,?,?,?,?);");
