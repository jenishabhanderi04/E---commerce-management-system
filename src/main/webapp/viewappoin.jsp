...
rs = stmt.executeQuery("SELECT COUNT(*) AS count FROM bookappointment");
if(rs.next()) {
 total = rs.getInt("count");
}

//Get rows for current page
rs = stmt.executeQuery("SELECT * FROM bookappointment LIMIT " + start + "," + limit);
...
<td> <%= rs.getString(9) %></td>
 ...
 <td><a href="acp.jsp?update=<%= rs.getString(1)%>" class="edit">Accept</a></td>
	 <td><a href="rej.jsp?delete=<%= rs.getString(1)%> " class="del">Reject</a></td>
