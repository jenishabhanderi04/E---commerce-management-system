...
<section class="display-product-table">
 ...
 <h1> Manage Service</h1>
      <thead>
         <tr><a href="addser.jsp " class="add">Add Service</a></tr>
...
<td><a href="updateser.jsp?update=<%= rs.getString(1)%>" class="edit">Update</a></td>
<td><a href="deleteser.jsp?delete=<%= rs.getString(1)%> " class="del">Delete</a></td>
...
rs = stmt.executeQuery("SELECT COUNT(*) AS count FROM service");
if(rs.next()) {
 total = rs.getInt("count");
}

//Get rows for current page
rs = stmt.executeQuery("SELECT * FROM service LIMIT " + start + "," + limit);
