...
try{
	...
	if(request.getParameter("update")!= null)
	{
	 String update = request.getParameter("update");
		...
		ResultSet rs = s.executeQuery("select * from package where id ="+update+"");
...
<section>
 ...
 <div class="L">
<div class="l-form">
<form action="updatepackage" method="post" class="form" enctype="multipart/form-data">
   <h3 class="form__title">Add New Package</h3>
	<input type="hidden" value="<%= request.getParameter("update")%>" name="Update">
    <div class="form__div">
   <input type="text" name="p_name" placeholder="" class="form__input" required value="<%= rs.getString("name") %>">
   <label for="" class="form__label" >Name</label>
</div>

 <div class="form__div">
   <input type="text" name="ser" min="0" placeholder="" class="form__input" required value="<%= rs.getString("service") %>">
   <label for="" class="form__label" >Service</label>
</div>

  <div class="form__div">
   <input type="number" name="p_price" min="0" placeholder="" class="form__input" required value="<%= rs.getString("price") %>">
