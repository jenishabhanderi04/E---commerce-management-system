...
try{
	...
	if(request.getParameter("update")!= null)
	{
	 String update = request.getParameter("update");
		...
		ResultSet rs = s.executeQuery("select * from pro where id ="+update+"");
...
<section>
 ...
 <div class="L">
<div class="l-form">
<form action="updateproduct" method="post" class="form" enctype="multipart/form-data">
   <h3 class="form__title">Add New Product</h3>
	<input type="hidden" value="<%= request.getParameter("update")%>" name="Update">
    <div class="form__div">
   <input type="text" name="name" placeholder="" class="form__input" required value="<%= rs.getString("name") %>">
   <label for="" class="form__label" >Name</label>
</div>

  <div class="form__div">
   <input type="number" name="price" min="0" placeholder="" class="form__input" required value="<%= rs.getString("price") %>">
   <label for="" class="form__label" >Price</label>
</div>

   <div class="form__div">
   <input type="file" name="image" accept="image/png, image/jpg, image/jpeg" class="form__input"required value="<%= rs.getString("image") %>">
