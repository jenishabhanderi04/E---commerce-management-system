...
<section class="display-product-table">
 ...
 <h1> Manage Product</h1>
      <thead>
         <tr><a href="addproduct.jsp " class="add">Add Product</a></tr>
         <th>product image</th>
         <th>product name</th>
         <th>product price</th>
         <th>edit</th>
...
<td><a href="updateproduct.jsp?update=<%= rs.getString(1)%>" class="edit">Update</a></td>
...
rs = stmt.executeQuery("SELECT COUNT(*) AS count FROM pro");
if(rs.next()) {
 total = rs.getInt("count");
}

//Get rows for current page
rs = stmt.executeQuery("SELECT * FROM pro LIMIT " + start + "," + limit);
