...
ResultSet rs = s.executeQuery("select * from bookpackage where user_id ="+sessionid+" ");
%> --%>
...
rs = stmt.executeQuery("SELECT COUNT(*) AS count FROM bookpackage where user_id ="+sessionid+"");
if(rs.next()) {
 total = rs.getInt("count");
}

//Get rows for current page
rs = stmt.executeQuery("SELECT * FROM bookpackage where user_id ="+sessionid+" LIMIT " + start + "," + limit);
...
<td><a href="deletebookpack.jsp?delete=<%= rs.getString(1)%> " class="del">Delete</a></td>
