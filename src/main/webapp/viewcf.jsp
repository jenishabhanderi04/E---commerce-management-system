...
rs = stmt.executeQuery("SELECT COUNT(*) AS count FROM feedback where user_id ="+sessionid+"");
if(rs.next()) {
 total = rs.getInt("count");
}

//Get rows for current page
rs = stmt.executeQuery("SELECT * FROM feedback where user_id ="+sessionid+" LIMIT " + start + "," + limit);
