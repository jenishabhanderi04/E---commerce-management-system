...
rs = stmt.executeQuery("SELECT COUNT(*) AS count FROM bookappointment where user_id ="+sessionid+"");
if(rs.next()) {
 total = rs.getInt("count");
}

//Get rows for current page
rs = stmt.executeQuery("SELECT * FROM bookappointment where user_id ="+sessionid+" LIMIT " + start + "," + limit);
