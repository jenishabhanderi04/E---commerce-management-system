...
<section class="display-product-table">
 ...
 <h1> Manage Package</h1>
      <thead>
         <tr><a href="addpack.jsp " class="add">Add Package</a></tr>
         <th>package image</th>
         <th>package name</th>
         <th>service</th>
         <th>price</th>
...
<td><a href="updatepack.jsp?update=<%= rs.getString(1)%>" class="edit">Update</a></td>
<td><a href="deletepack.jsp?delete=<%= rs.getString(1)%> " class="del">Delete</a></td>
...
rs = stmt.executeQuery("SELECT COUNT(*) AS count FROM package");
if(rs.next()) {
 total = rs.getInt("count");
}

//Get rows for current page
rs = stmt.executeQuery("SELECT * FROM package LIMIT " + start + "," + limit);
