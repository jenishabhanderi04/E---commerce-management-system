...
rs = stmt.executeQuery("SELECT COUNT(*) AS count FROM payment where userid ="+sessionid+"");
if(rs.next()) {
 total = rs.getInt("count");
}

//Get rows for current page
rs = stmt.executeQuery("SELECT * FROM payment where userid ="+sessionid+" LIMIT " + start + "," + limit);
